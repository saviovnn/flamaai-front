<template>
  <div class="relative">
    <button 
      @click="toggleMenu"
      class="w-full flex items-center gap-2.5 px-2 py-1.5 rounded-lg hover:bg-gray-100 transition-colors"
    >
    ...
    <Transition name="menu">
      <div 
        v-if="isOpen"
        class="absolute bottom-full left-0 mb-2 bg-white rounded-xl shadow-lg border border-gray-200 py-1.5 z-50 whitespace-nowrap"
      >
        <button
          @click="handleConfiguracao"
          class="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-gray-50 transition-colors text-left"
        >
